  ...
  return (
    <>
      ...
      <div className='text-white w-full flex flex-col h-155 justify-center items-center bg-[url(https://images.unsplash.com/photo-1532012197267-da84d127e765?ixid=MnwyNTE2NnwwfDF8c2VhcmNofDM0fHxib29rc3xlbnwwfHx8fDE2ODI1MDIxMjQ&ixlib=rb-4.0.3&q=85&w=2160)] bg-cover bg-center'>
        ...
        <div className='my-3'>
          <input onChange={e => setSearchKey(e.target.value)} type="text" className='bg-white px-4 py-3 rounded-full placeholder-gray-400 w-100 font-semibold text-black' placeholder='Search book' />
          <FontAwesomeIcon onClick={searchBook} style={{ marginLeft: '-40px' }} className='text-gray-400 z-5 cursor-pointer' icon={faMagnifyingGlass} />
        </div>
