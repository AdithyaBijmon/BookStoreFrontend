  ...
  return (
    <div className='bg-[url(https://cdn.pixabay.com/photo/2024/10/12/17/15/flowers-9115519_1280.jpg)] min-h-screen w-full bg-cover flex flex-col items-center justify-center'>
      ...
      <div style={{ backgroundColor: 'rgba(255, 255, 255, 0.33)' }} className='rounded p-3 w-95 flex justify-center items-center flex-col'>
        ...
        <input onChange={(e) => setUserDetails({ ...userDetails, email: e.target.value })} type="text" className='placeholder-gray-600 w-full p-3 my-5 rounded' style={{ backgroundColor: 'rgba(255, 255, 255, 0.47)' }} placeholder='Enter your email' />

        <div className='flex items-center w-full'>
          <input onChange={(e) => setUserDetails({ ...userDetails, password: e.target.value })} type={viewPasswordStatus ? "text" : "password"} className='placeholder-gray-600 w-full p-3 rounded ' style={{ backgroundColor: 'rgba(255, 255, 255, 0.47)' }} placeholder='Enter your password' />
        ...
        {
          register ?
            <button type='button' onClick={handleRegister} className='w-full bg-green-700 text-white px-5 py-2 text-xl'>Register</button> : <button className='w-full bg-green-700 text-white px-5 py-2 text-xl'>Login</button>
        }
